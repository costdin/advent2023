...
fn fold(state: u32, digit: char, only_num: bool, rev: bool) -> ControlFlow<u32, u32> {
    match if digit.is_numeric() {
        ...
        MAP[if rev { 728 } else { 0 } + ((state - 10) * 26) as usize + (digit as u8 - b'a') as usize]
    } {
...
const MAP: [u32; 1456] = [
    ...
    34, 32, 37, 37, 37, 37, 37, 30, 37, 37, 37, 37, 22, 37, 37, 37, 37, 37, 37, 37, 37, 11, 28, 37, 37, 21, 37, 32, 37, 25, 37, 30,
